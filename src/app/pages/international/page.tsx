        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Programmes d'échanges, partenariats internationaux et mobilité étudiante
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-200 rounded-xl p-10 text-center mb-12 shadow-lg">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Cette section présentera prochainement nos programmes d'échanges internationaux, nos universités partenaires et les opportunités de mobilité.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-green-100 hover:shadow-xl transition-shadow">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent mb-6">🌍 International</h3>
